 ...
 * Supabase Schema SQL
 *
 * This file exports the SQL migration script that users must run in their Supabase project.
 * The SQL is used by the "Copy SQL" button in the Cloud Sync Settings modal.
 *
 * IMPORTANT: Keep this synchronized with specs/002-cloud-sync/contracts/supabase-schema.sql
 */
